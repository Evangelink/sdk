...
namespace Microsoft.DotNet.ApiCompatibility.Rules.Tests
{
    public class AssemblyIdentityMustMatchTests
    {
        ...
        public void AssemblyKeyTokenMustBeCompatible(bool strictMode)
        {
            ...
            Assert.AreEqual(_publicKey, leftSymbol.Identity.PublicKey);
            Assert.AreEqual(_publicKey, rightSymbol.Identity.PublicKey);
...
";
            ...
            Assert.HasCount(0, differ.GetDifferences(leftSymbol, rightSymbol));
        }
    }
}
