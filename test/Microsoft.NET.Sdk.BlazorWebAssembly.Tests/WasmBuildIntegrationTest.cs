...
{
    [TestClass]
    public class WasmBuildIntegrationTest(MSTestContext testContext) : BlazorWasmBaselineTests(testContext, GenerateBaselines)
    {
        ...
        [TestMethod][MSBuildVersionCondition("17.12", IgnoreMessage = "Needs System.Text.Json 8.0.5")]
        [DataRow("blazor")]
