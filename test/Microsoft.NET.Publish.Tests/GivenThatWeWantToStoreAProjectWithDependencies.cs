...
namespace Microsoft.NET.Publish.Tests
{
    ...
    public class GivenThatWeWantToStoreAProjectWithDependencies : SdkTest
    {
        ...
        public GivenThatWeWantToStoreAProjectWithDependencies(MSTestContext testContext) : base(testContext)
        {
        }
        ...
        public void compose_dependencies()
        {
            ...
            var storeCommand = new ComposeStoreCommand(MSTestContext, simpleDependenciesAsset.TestRoot, "FluentAssertion.xml");
        ...
        public void compose_multifile()
        {
            ...
            var storeCommand = new ComposeStoreCommand(MSTestContext, simpleDependenciesAsset.TestRoot, "NewtonsoftFilterProfile.xml")
            {
        ...
        public void It_uses_star_versions_correctly()
        {
            ...
            new ComposeStoreCommand(MSTestContext, targetManifestsAsset.TestRoot, "StarVersion.xml")
        ...
        public void It_creates_profiling_symbols()
        {
            ...
            var composeStore = new ComposeStoreCommand(MSTestContext, targetManifestsAsset.TestRoot, "NewtonsoftFilterProfile.xml");
        ...
        public void It_stores_when_targeting_netcoreapp3(bool isExe)
        {
            ...
            new ComposeStoreCommand(MSTestContext, testProjectInstance.TestRoot, testProject.Name)
                .Execute(
        ...
        public void DotnetStoreWithPrunedPackages()
        {
            ...
            var composeStore = new ComposeStoreCommand(MSTestContext, targetManifestsAsset.TestRoot, "PrunePackages.xml")
                .Execute(
