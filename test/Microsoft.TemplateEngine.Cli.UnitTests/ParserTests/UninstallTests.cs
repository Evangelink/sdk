...
namespace Microsoft.TemplateEngine.Cli.UnitTests.ParserTests
{
    public class UninstallTests : BaseTest
    {
        ...
        public void CommandExampleCanShowParentCommandsBeyondNew()
        {
            ...
            Assert.AreEqual("dotnet new uninstall my-source", Example.For<NewCommand>(parseResult).WithSubcommand<UninstallCommand>().WithArgument(BaseUninstallCommand.NameArgument, "my-source"));
        }
    }
}
