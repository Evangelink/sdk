...
namespace Microsoft.DotNet.ApiCompat.Task.IntegrationTests
{
    public class ValidatePackageTargetIntegrationTests : SdkTest
    {
        ...
        public void InvalidPackage()
        {
            ...
            var result = new PackCommand(MSTestContext, Path.Combine(testAsset.TestRoot, "PackageValidationTestProject.csproj"))
        ...
        public void ValidatePackageTargetRunsSuccessfullyWithBaselineCheck()
        {
            ...
            result = new PackCommand(MSTestContext, Path.Combine(testAsset.TestRoot, "PackageValidationTestProject.csproj"))
