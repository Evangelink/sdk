...
namespace Microsoft.TemplateEngine.Cli.UnitTests.ParserTests
{
    public class InstallTests : BaseTest
    {
        ...
        public void Install_CanParseAddSourceOption(string optionName)
        {
            ...
            Assert.ContainsSingle(args.AdditionalSources);
            Assert.Contains("my-custom-source", args.AdditionalSources);
            Assert.ContainsSingle(args.TemplatePackages);
        ...
        public void CommandExampleCanShowParentCommandsBeyondNew()
        {
            ...
            Assert.AreEqual("dotnet new install my-source", Example.For<NewCommand>(parseResult).WithSubcommand<InstallCommand>().WithArgument(BaseInstallCommand.NameArgument, "my-source"));
        }
