...
namespace Microsoft.NET.Sdk.BlazorWebAssembly.Tests
{
    ...
    {
        public WasmPublishIntegrationTest(MSTestTestContext testContext) : base(testContext) { }
        ...
        public void Publish_HostedApp_WithoutTrimming_Works()
        {
            ...
            // Verify project references appear as static web assets
            // Also verify project references to the server project appear in the publish testContext
            publishDirectory.Should().HaveFiles(new[]
            {
                "wwwroot/_framework/RazorClassLibrary.wasm",
                "RazorClassLibrary.dll"
    ...
    """));
            ...
            var publishCommand = new DotnetPublishCommand(MSTestContext, Path.Combine(testInstance.TestRoot, "blazorhosted"));
