...
namespace Microsoft.TemplateEngine.Cli.UnitTests.ParserTests
{
    public class SearchTests : BaseTest
    {
        ...
        public void CommandExampleCanShowParentCommandsBeyondNew()
        {
            ...
            Assert.AreEqual("dotnet new search my-template", Example.For<NewCommand>(parseResult).WithSubcommand<SearchCommand>().WithArgument(BaseSearchCommand.NameArgument, "my-template"));
        }
        ...
        public void CommandExampleShowsMandatoryArg()
        {
            ...
            ParseResult parseResult = rootCommand.Parse("dotnet new search template");
            Assert.AreEqual("dotnet new search [<template-name>]", Example.For<NewCommand>(parseResult).WithSubcommand<SearchCommand>().WithArgument(BaseSearchCommand.NameArgument));
        }
        ...
        public void CommandExampleShowsOptionalArgWhenOptionsAreGiven()
        {
            ...
            ParseResult parseResult = rootCommand.Parse("dotnet new search template");
            Assert.AreEqual("dotnet new search [<template-name>] --author Microsoft", Example.For<NewCommand>(parseResult).WithSubcommand<SearchCommand>().WithArgument(BaseSearchCommand.NameArgument).WithOption(SharedOptionsFactory.CreateAuthorOption(), "Microsoft"));
        }
    }
}
