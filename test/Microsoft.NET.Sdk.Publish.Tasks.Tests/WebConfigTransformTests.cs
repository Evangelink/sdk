...
namespace Microsoft.Net.Sdk.Publish.Tasks.Tests
{
    ...
    public class WebConfigTransformTests
    {
        ...
        {
            var testContext = WebConfigTransform.Transform(WebConfigTransformTemplates.WebConfigTemplate, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModuleName: attributeValue, aspNetCoreHostingModel: null, environmentName: null, projectFullPath: null);
            Assert.AreEqual("AspNetCoreModule", (string)testContext.Descendants(elementName).Single().Attribute(attributeName));
        }
        ...
        public void WebConfigTransform_UsingAspNetCoreModule_SupportsOutOfProc(string elementName, string attributeName, string attributeValue)
        {
            ...
            Assert.AreEqual(attributeValue, (string)testContext.Descendants(elementName).Single().Attribute(attributeName));
        }
        ...
        {
            var testContext = WebConfigTransform.Transform(null, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModuleName: aspNetCoreModuleName, aspNetCoreHostingModel: attributeValue, environmentName: null, projectFullPath: null);
            Assert.AreEqual(attributeValue, (string)testContext.Descendants(elementName).Single().Attribute(attributeName));
        }
        ...
        public void WebConfigTransform_will_append_Env_IfPassed()
        {
            ...
            var testContext = WebConfigTransform.Transform(input, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModuleName: null, aspNetCoreHostingModel: null, environmentName: "Production", projectFullPath: null);
            Assert.IsTrue(XNode.DeepEquals(testContext, WebConfigTransformTemplates.WebConfigTemplateWithEnvironmentVariable));
        }
        ...
        public void WebConfigTransform_will_Override_Env_IfUpdated()
        {
            ...
            var testContext = WebConfigTransform.Transform(input, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModuleName: null, aspNetCoreHostingModel: null, environmentName: "Staging", projectFullPath: null);
            Assert.AreEqual("Staging", (string)testContext.Descendants("environmentVariable").Single().Attribute("value"));
        }
        ...
        public void WebConfigTransform_HandlesLocations_Correctly(XDocument template)
        {
            ...
            var testContext = WebConfigTransform.Transform(input, "test.dll", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModuleName: null, aspNetCoreHostingModel: null, environmentName: null, projectFullPath: null);
            Assert.IsTrue(XNode.DeepEquals(testContext, template));
        }
        ...
        public void WebConfigTransform_does_not_remove_children_of_aspNetCore_element()
        {
            ...
            var testContext = WebConfigTransform.Transform(input, "app.exe", configureForAzure: false, useAppHost: true, extension: ".exe", aspNetCoreModuleName: null, aspNetCoreHostingModel: null, environmentName: "Test", projectFullPath: null);

            Assert.AreEqual("Test", (string)testContext.Descendants("environmentVariable").SingleOrDefault(e => (string)e.Attribute("name") == "ASPNETCORE_ENVIRONMENT").Attribute("value"));
        }
        ...
        {
            var input = WebConfigTransformTemplates.WebConfigTemplate;
            var testContext = WebConfigTransform.Transform(input, "test.dll", configureForAzure: true, useAppHost: true, extension: ".exe", aspNetCoreModuleName: null, aspNetCoreHostingModel: null, environmentName: null, projectFullPath: null);

            Assert.AreEqual(
                @"\\?\%home%\LogFiles\stdout",
                (string)testContext.Descendants("aspNetCore").Single().Attribute("stdoutLogFile"));
        }
        ...
        public void WebConfigTransform_removes_LAUNCHER_ARGS_from_arguments_for_standalone_apps(string inputArguments, string testContextArguments)
        {
            var input = WebConfigTransformTemplates.WebConfigTemplate;
            ...
            Assert.AreEqual(testContextArguments, (string)aspNetCoreElement.Attribute("arguments"));
        }
        ...
        public void WebConfigTransform_wont_override_existing_args_for_portable_apps(string inputArguments, string testContextArguments)
        {
            var input = WebConfigTransformTemplates.WebConfigTemplate;
            input.Descendants("aspNetCore").Single().SetAttributeValue("arguments", inputArguments);
